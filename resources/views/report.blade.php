...
<div class="card">
    <div class="card-header">
        ...
        <div class="ms-3 card-tab">
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="eventReport-tab" data-bs-toggle="tab"
                        data-bs-target="#eventReport-pane" type="button" role="tab"
                        aria-controls="eventReport-pane" aria-selected="false"> {{ __('Event reports')}} </button>
                </li>
            </ul>
        </div>
    </div>
    <div class="card-body">
        <div class="tab-content" id="myTabContent">
            ...
            <div class="tab-pane" id="eventReport-pane" role="tabpanel" tabindex="0">
                <table class="table table-striped w-100" id="fetchEventReport">
                    <thead>
                        <tr>
